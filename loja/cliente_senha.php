...
<head>
    ...
    <title>Tech Dev Online :: Área do Cliente :: Alteração de Senha</title>
</head>
                ...
                <div class="row gx-3">
                    <div class="col-4">
                        <div class="list-group">
                            ...
                            <a href="cliente_senha.html" class="list-group-item list-group-item-action bg-info text-light">
                    ...
                    <div class="col-8">
                        <form class="col-sm-12 col-md-8 col-lg-6">
                            ...
                            <button type="button" onclick="window.location.href='/confirmcadastrosenha.html'"
                                class="btn btn-lg btn-info">Alterar Senha</button>
                        </form>
                    </div>
                </div>
            </div>
