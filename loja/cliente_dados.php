...
<head>
    ...
    <title>Tech Dev Online :: Área do Cliente :: Dados Pessoais</title>
</head>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <div class="align-self-end">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a href="cliente_dados.html" class="nav-link text-white">Logado como <b>Ricardo Maroquio</b></a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="row gx-3">
                    <div class="col-4">
                        <div class="list-group">
                            <a href="cliente_dados.html" class="list-group-item list-group-item-action bg-info text-light">
