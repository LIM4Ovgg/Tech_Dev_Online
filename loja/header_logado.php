    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav flex-grow-1">
                <li class="nav-item">
                    <a class="nav-link text-white" href="<?php echo $sistema ?>index.php">Principal</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="<?php echo $sistema ?>contato.php">Contato</a>
                </li>
            </ul>
            <div class="align-self-end">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <span class="badge rounded-pill bg-light text-info position-absolute ms-4 mt-0" title="<?php echo $row_count ?> produto(s) no carrinho"><small><?php echo $row_count ?></small></span>
