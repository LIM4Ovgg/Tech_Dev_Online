                    ...
                    <div class="col-8">
                        <form class="col-sm-12 col-md-8 col-lg-6">
                            <div class="form-floating mb-3">
                                ...
                                <label for="txtSenhaAtual">Digite a senha atual</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="password" id="txtSenha" class="form-control" placeholder=" ">
                                <label for="txtSenha">Digite a nova senha</label>
                            </div>
                            ...
                            <button type="button" onclick="window.location.href='confirmcadastrosenha.php'" class="btn btn-lg btn-info text-white">Alterar Senha</button>
                        </form>
                    </div>
                </div>
            </div>
