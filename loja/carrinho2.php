                            ...
                            <li class="list-group-item py-3">
                                <div class="row g-3">
                                    <div class="col-4 col-md-3 col-lg-2">
                                        <a href="#">
                                            <img src="img/produtos/<?php echo $fetch_cart['imagem'] ?>" class="img-thumbnail">
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-6 offset-6 col-sm-6 offset-sm-6 col-md-4 offset-md-8 col-lg-3 offset-lg-0 col-xl-2 align-self-center mt-3">
                                        <form action="" method="POST">
                                            <div class="input-group">
                                                <a class="btn btn-outline-dark btn-sm" href="carrinho2.php?diminuir=<?php echo $fetch_cart['id'] ?>">
                                                ...
                                                <a class="btn btn-outline-dark btn-sm" href="carrinho2.php?aumentar=<?php echo $fetch_cart['id'] ?>">
                                                    <i class="bi-caret-up" style="font-size: 16px; line-height: 16px;"></i>
                                                </a>
                                                <a class="btn btn-outline-info border-dark btn-sm" href="carrinho2.php?remover=<?php echo $fetch_cart['id'] ?>" onclick="return confirm('Remover item do carrinho?')">
