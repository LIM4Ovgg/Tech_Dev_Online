...
<head>
    ...
    <title>Tech Dev Online :: Área do Cliente :: Favoritos</title>
</head>
                ...
                <div class="row gx-3 mb-3">
                    <div class="col-4">
                        <div class="list-group">
                            ...
                            <a href="cliente_favoritos.html" class="list-group-item list-group-item-action bg-info text-light">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                                <div class="card text-center bg-light">
                                    <a href="#" class="position-absolute end-0 p-2 text-info" title="Remover dos favoritos">
                                    ...
                                    <div class="card-footer">
                                        <a href="carrinho.html" class="btn btn-info mt-2 d-block">
